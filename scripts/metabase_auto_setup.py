...
EMAIL = os.environ.get("METABASE_ADMIN_EMAIL", "admin@hranalytics.local")
PASSWORD = os.environ.get("METABASE_ADMIN_PASSWORD", "SuperSegura123!")
FIRST = os.environ.get("METABASE_ADMIN_FIRST_NAME", "Admin")
LAST = os.environ.get("METABASE_ADMIN_LAST_NAME", "Metabase")
SITE = os.environ.get("METABASE_SITE_NAME", "HR Analytics Metabase")
